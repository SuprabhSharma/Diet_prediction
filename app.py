...
with col3:
    ...
    adherence = st.number_input("Diet Adherence %", 0.0, 100.0, 70.0)
...
if st.button("🔍 Predict Diet Recommendation"):
    ...
    diet_guidance = {
        "Low_Fat": {
            "eat": "Vegetables, fruits, whole grains, low-fat dairy",
            "avoid": "Fried food, butter excess, salty pickles"
        },
        "Low_Carb": {
            "eat": "Leafy veggies, eggs, paneer, nuts",
            "avoid": "Rice, sweets, bakery foods"
        },
        "Balanced": {
            "eat": "Vegetables, dal, fruits, whole grains",
            "avoid": "Junk food, excess sugar/salt"
        }
    }
